# Contributing to CALAGUA

We would love for you to contribute to CALAGUA and help make it ever better together! :rocket:
...
Help us keep CALAGUA open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `CALAGUA`.
...
* If you have a question about using CALAGUA, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `CALAGUA:master`.
...
we use the git commit messages to **generate the CALAGUA change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/CALAGUA
[stackoverflow]: https://stackoverflow.com/questions/tagged/CALAGUA
[issues]: https://github.com/akveo/CALAGUA/issues
[new_issue]: https://github.com/akveo/CALAGUA/issues/new
[pulls]: https://github.com/akveo/CALAGUA/pulls
